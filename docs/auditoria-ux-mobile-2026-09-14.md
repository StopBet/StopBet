...
- [ ] **SIS-06** · Restos del tema anterior y colores fuera de los tokens. **Arreglo:** mover todo a tokens y borrar los restos. _(cada dueño en su pantalla)_
- [ ] **SIS-07** · Sin modo oscuro. **Arreglo:** tema oscuro por tokens. _(cada dueño en su pantalla)_
- [ ] **SIS-08** · No respeta «reducir movimiento». **Arreglo:** leer el ajuste y usar fundidos simples. _(cada dueño en su pantalla)_
- [ ] **SIS-09** · 19 textos de menos de 12 px. **Arreglo:** piso de 12 px y probar con letra del sistema al 130 % (una vez resuelto AND-01). _(cada dueño en su pantalla)_
...
- [ ] **LOG-03** · «¡Nueva insignia!» al volver a compartir una vieja. **Arreglo:** titular según el caso ("Comparte tu insignia") y colores de la paleta. _(HdU03 · sin dueño en Sprint 1)_
...
- [ ] **SIS-13** · Identidad de demo fija en la interfaz. **Arreglo:** Ver detalle. _(cada dueño en su pantalla)_
